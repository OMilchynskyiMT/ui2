<template>
  <div
    ...
    class="table"
  >
    <UiScrollArea axis="both" class="scroll" scrollbar-gutter="auto">
        ...
        <tbody v-if="loading">
          <tr>
            <td :colspan="columnSpan" class="state loading">
              <div class="loading">
                <slot name="loading">
                  <UiSpinner :stroke-width="4" size="1.5rem" />
...
import type { TableColumn, TableProperties, TableSlots, TableSort } from './table.types'
