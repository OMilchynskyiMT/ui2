...
<script lang="ts">
export type UiScrollAreaAxis = 'block' | 'inline' | 'both'
export type UiScrollAreaProperties = {
  axis?: UiScrollAreaAxis
  fadeEdges?: boolean
  overscroll?: 'auto' | 'contain' | 'none'
  scrollbarGutter?: 'auto' | 'stable' | 'stable both-edges'
}
export type UiScrollAreaExpose = {
...
const {
  ...
  overscroll = 'auto',
  scrollbarGutter,
} = defineProps<UiScrollAreaProperties>()
...
defineExpose<UiScrollAreaExpose>({
  get viewport() {
