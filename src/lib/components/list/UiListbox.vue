...
export type UiListboxProperties<V> = {
  id?: string
...
const { id = useId(), items, ariaLabel, ariaLabelledby } = defineProps<UiListboxProperties<V>>()
...
defineExpose<UiListboxExpose>({ focus })
</script>
