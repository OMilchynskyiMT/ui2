...
export type UiFieldVariant = 'outlined' | 'filled'
export type UiFieldSize = 'small' | 'medium'
...
export type UiFieldExpose = {
  focus: (options?: FocusOptions) => void
  blur: () => void
  select: () => void
}

export const createFieldExpose = (getField: () => UiFieldExpose | null | undefined): UiFieldExpose => ({
