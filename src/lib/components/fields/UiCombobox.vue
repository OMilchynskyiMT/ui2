...
import type { UiFieldExpose, UiFieldProperties } from './field.shared'

export type ComboboxModel = string | number | null

export type UiComboboxProperties<V extends string | number> = Omit<
  UiFieldProperties,
...
export type UiComboboxExpose = UiFieldExpose
</script>
...
} = defineProps<UiComboboxProperties<V>>()
