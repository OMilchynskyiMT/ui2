  ...
  >
    ...
    >
      ...
      <span aria-hidden="true" class="indicator">
        <UiIcon :icon="ChevronDownIcon" size="1rem" />
      </span>
    </button>
...
export type UiSelectProperties<V extends string | number> = Omit<
  UiFieldProperties,
...
const {
  ...
  variant = 'outlined',
  size = 'medium',
} = defineProps<UiSelectProperties<V>>()
