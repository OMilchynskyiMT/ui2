...
export type { UiFieldExpose } from './field.shared'
...
export type UiTextFieldProperties = Omit<UiFieldProperties, 'id' | 'focused' | 'populated' | 'multiline'> & {
  id?: string
...
const {
  ...
  variant = 'outlined',
  size = 'medium',
} = defineProps<UiTextFieldProperties>()
